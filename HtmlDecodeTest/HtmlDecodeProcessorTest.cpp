...
BOOST_AUTO_TEST_CASE(return_source_string_if_it_does_not_have_html_entities)
{
...
BOOST_AUTO_TEST_CASE(return_source_string_if_html_entities_are_wrong)
{
...
BOOST_AUTO_TEST_CASE(program_work_correctly_with_wrong_and_right_html_entities_without_another_words)
{
...
BOOST_AUTO_TEST_CASE(program_work_correctly_with_html_entities)
{
