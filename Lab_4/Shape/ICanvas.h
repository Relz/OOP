...
public:
    ...
    virtual void DrawCircle(CPoint const& center, double radius, Color const& outlineColor) = 0;
    virtual void FillCircle(CPoint const& center, double radius, Color const& fillColor) = 0;
};